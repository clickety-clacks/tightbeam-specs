...
13. **I-13 — Binding transition.** A Tightbeam credential-lifecycle transition or terminal provider account event shall atomically retire the current capture claim, create a binding generation, clear the old projection, and establish the new binding state before a new full read starts.
