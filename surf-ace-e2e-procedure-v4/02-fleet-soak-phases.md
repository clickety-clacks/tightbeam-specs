...
### 1.5 CLI discovery and per-surface admission gate
...
2. Record the Gibson execution host, controller endpoint fixture identity, fixture expiry and cleanup contract, product label, and empty run-owned state root.
