...
2. Verify the controller endpoint fixture, its identity, expiry, cleanup contract, and Gibson reachability. Create or select the empty run-specific state root.
